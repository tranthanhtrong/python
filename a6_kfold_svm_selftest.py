...
def kfold_svm_selftest(filenameTrain, resultColName, fileListTest, nTimes, percentTest, coef_percent, numK):
    print(textcolor_display("3. Correclation Matrix - K-fold SVM Selftest", color.OKBLUE))
    print("Train by " + str(filenameTrain) + ", run test " + str(nTimes) + " times, use " + str(
